...
bbox = cv2.selectROI("Volleyballing",img,False)

#initialise the tracker on the img and the bounding box
tracker.init(img,bbox)
def drawBox(img,bbox):
    x,y,w,h= int(bbox[0]), int(bbox[1]), int(bbox[2]), int(bbox[3])
    cv2.rectangle(img,(x,y),((x+w),(y+h)),(107,170,71),3,1)
    cv2.putText(img,"Tracking.....",(75,90),cv2.FONT_HERSHEY_TRIPLEX,0.7,(130,23,97))
...
while True:
   ...
   if success:
       ...
       cv2.putText(img,"Lost",(75,90),cv2.FONT_HERSHEY_SCRIPT_SMALL,0.8,(230,120,78),3)
